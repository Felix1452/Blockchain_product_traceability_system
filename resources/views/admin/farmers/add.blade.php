...
@section('content')
    ...
    <form action="" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text" name="tenchunhatrong" value="{{old('tenchunhatrong')}}" class="form-control"  placeholder="Nhập tên chủ cơ sở ">
                    </div>
                </div>
            </div>
        ...
        <div class="card-footer">
            <button type="submit" class="btn btn-primary">Thêm Nhà Vườn</button>
        </div>
        @csrf
    </form>
@endsection
